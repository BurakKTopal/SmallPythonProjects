...
class Agent1:
    ...
    def get_state(self, game):
        ...
        move_right, move_left = 0, 0
        if game.board_player_one[0] < game.ball[0]:
            ball_right = 1
        elif game.board_player_one[0] > game.ball[0]:
            ball_left = 1
        else:
            ball_straight = 1

        if game.board_player_one_direction == -game.board_speed:
            move_left = 1
        elif game.board_player_one_direction == game.board_speed:
            move_right = 1
    ...
    def get_action(self, state, game):
        ...
        if random.randint(0, 220) < self.epsilon:
            ...
            final_move[move] = 1
        game.board_player_one_direction = direction[move]
        return final_move
